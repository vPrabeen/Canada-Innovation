	...
	*/
	...
	public function custom_dashboard_help() {
		...
		foreach ( $reviewrows as $review ) 
		{
			...
			echo '<li>'.$avatarhtml.'<div class="wprev_dash_stars">'.$starhtml.'</div><h4 class="wprev_dash_name">'.$review->reviewer_name.' - <span class="wprev_dash_timeago">'.$daysagohtml.'</span></h4><p class="wprev_dash_text">'.$reviewtext.'</p></li>';
