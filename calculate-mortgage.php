...
function generateReport($principal,$payment_term,$interest_rate, $amortization_schedule, $payment, $frequency, $type_of_mortgage_txt, $amortization_chart,$env){
	...
	<table>
		<tr>
			<td style="text-align: left;vertical-align:text-top;"><a href="#"><img src="https://bc-mortgage-broker.ca/wp-content/themes/FoundationPress-child/src/assets/images/logo.png" alt="" style="width:160px;height:53px;"></a></td>
			<td style="text-align:right;vertical-align:text-top;"><img src="https://bc-mortgage-broker.ca/wp-content/themes/FoundationPress-child/assets/images/abc.png" alt="" width="60" height="60"></td> 
		</tr>
		
		<tr style="vertical-align: bottom;">
			<td>
				<table style="width: 100%;text-align: left;border-bottom:0.5px solid #030303; padding-bottom:10px;">
			...
			<td style="text-align: right;font-size: 9px;border-bottom:0.5px solid #030303;">
				<table style="width: 100%;color: #000000;">
					<tr><td><b>Name:</b> <span style="color:#717d7e;">Jeff Evans</span></td></tr>
	...
	$html .= '</table></div></main></body></html>';
		...
		if($env==1){ // Live
			$pdf_file_path	=  "https://bc-mortgage-broker.ca/amortization_report/Personalized_Mortgage_Report.pdf";
		} else if($env==2){ // Local
			$pdf_file_path	=  "https://bc-mortgage-broker.ca/mortgage-calculator/amortization_report/Personalized_Mortgage_Report.pdf";
		} else if($env==3){ // Test
			$pdf_file_path	=  "https://bc-mortgage-broker.ca/amortization_report/Personalized_Mortgage_Report.pdf";
		} 
...
$response_data = array(
						'status'=>"success",
						'display_payment'=>'$'.number_format(round($payment)).' '.$pay_frequency_txt.'', 
						'display_mortgage_amount'=>'$'.number_format($principal).'', 
						'display_payment_term'=>''.$amortization_details['new_mortgage_length'].'', 
